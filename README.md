...
- Docker: For fun I had the strech goal of having these all easily runnable with docker compose but realized I didn't have time to mess with the port forwarding as each node also needs a TCP connection for GRPC as a client. Easily solveable but I simply ran out of time.
